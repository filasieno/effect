...
//     // IO Routines
//     op::ExecIO io_open(const AkChar* path, int flags, mode_t mode) noexcept;
//     op::ExecIO io_open_at(int dfd, const AkChar* path, int flags, mode_t mode) noexcept;
//     op::ExecIO io_open_at_direct(int dfd, const AkChar* path, int flags, mode_t mode, unsigned file_index) noexcept;
//     op::ExecIO io_open_at2(int dfd, const AkChar* path, struct open_how* how) noexcept;
//     op::ExecIO io_open_at2_direct(int dfd, const AkChar* path, struct open_how* how, unsigned file_index) noexcept;
//     op::ExecIO io_open_direct(const AkChar* path, int flags, mode_t mode, unsigned file_index) noexcept;
...
//     #endif
//     op::ExecIO io_mkdir(const AkChar* path, mode_t mode) noexcept;
//     op::ExecIO io_mkdir_at(int dfd, const AkChar* path, mode_t mode) noexcept;
//     op::ExecIO io_symlink(const AkChar* target, const AkChar* linkpath) noexcept;
//     op::ExecIO io_symlink_at(const AkChar* target, int newdirfd, const AkChar* linkpath) noexcept;
//     op::ExecIO io_link(const AkChar* oldpath, const AkChar* newpath, int flags) noexcept;
//     op::ExecIO io_link_at(int olddfd, const AkChar* oldpath, int newdfd, const AkChar* newpath, int flags) noexcept;
//     op::ExecIO io_unlink(const AkChar* path, int flags) noexcept;
//     op::ExecIO io_unlink_at(int dfd, const AkChar* path, int flags) noexcept;
//     op::ExecIO io_rename(const AkChar* oldpath, const AkChar* newpath) noexcept;
//     op::ExecIO io_rename_at(int olddfd, const AkChar* oldpath, int newdfd, const AkChar* newpath, unsigned int flags) noexcept;
...
//     op::ExecIO io_statx(int dfd, const AkChar* path, int flags, unsigned mask, struct statx* statxbuf) noexcept;
...
//     op::ExecIO io_get_xattr(const AkChar* name, AkChar* value, const AkChar* path, unsigned int len) noexcept;
//     op::ExecIO io_set_xattr(const AkChar* name, const AkChar* value, const AkChar* path, int flags, unsigned int len) noexcept;
//     op::ExecIO io_fget_xattr(int fd, const AkChar* name, AkChar* value, unsigned int len) noexcept;
//     op::ExecIO io_fset_xattr(int fd, const AkChar* name, const AkChar* value, int flags, unsigned int len) noexcept;
