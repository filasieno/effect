...
DefineTask MainTask() noexcept {
	alignas(64) char bitField[64];
    // Write a Test for the FindFreeListBucket function
    ...
    // Add more tests if needed, but this covers main cases
