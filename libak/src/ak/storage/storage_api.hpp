...
namespace ak 
{
    struct FrameId 
    {
        ...
        explicit FrameId(const AkU32& id) noexcept : id(id) {}
        FrameId() = default;
        ...
        constexpr AkBool operator==(const FrameId& other) const noexcept { return id == other.id; }
        constexpr AkBool operator!=(const FrameId& other) const noexcept { return id != other.id; }
        constexpr AkBool operator<(const FrameId& other) const noexcept { return id < other.id; }
        constexpr AkBool operator>(const FrameId& other) const noexcept { return id > other.id; }
        constexpr AkBool operator<=(const FrameId& other) const noexcept { return id <= other.id; }
    ...
    struct PageId 
    {
        ...
        explicit PageId(const AkU32& id) noexcept : id(id) {}
        ...
        constexpr operator AkBool() const noexcept { return id != 0; }
        AkBool operator==(const PageId& other) const noexcept { return id == other.id; }
        AkBool operator!=(const PageId& other) const noexcept { return id != other.id; }
        AkBool operator<(const PageId& other) const noexcept { return id < other.id; }
        AkBool operator>(const PageId& other) const noexcept { return id > other.id; }
        AkBool operator<=(const PageId& other) const noexcept { return id <= other.id; }
